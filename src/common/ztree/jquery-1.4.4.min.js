...
(function (E, B) {
  function ka (a, b, d) { if (d === B && a.nodeType === 1) { d = a.getAttribute('data-' + b); if (typeof d === 'string') { try { d = d === 'true' ? true : d === 'false' ? false : d === 'null' ? null : !c.isNaN(d) ? parseFloat(d) : Ja.test(d) ? c.parseJSON(d) : d; } catch (e) {}c.data(a, b, d); } else d = B; } return d; } function U () { return false; } function ca () { return true; } function la (a, b, d) { d[0].type = a; return c.event.handle.apply(b, d); } function Ka (a) {
    var b; var d; var e; var f; var h; var l; var k; var o; var x; var r; var A; var C = []; f = []; h = c.data(this, this.nodeType ? 'events' : '__events__'); if (typeof h === 'function') {
      h =
h.events;
...
h.preType === 'mouseleave') { a.type = h.preType; e = c(a.relatedTarget).closest(h.selector)[0]; } if (!e || e !== l)C.push({ elem: l, handleObj: h, level: r.level });
    ...
    var d = 0; b.each(function () {
      if (this.nodeName === (a[d] && a[d].nodeName)) {
        var e = c.data(a[d++]); var f = c.data(this,
    ...
    if (!ea[a]) {
      var b = c('<' +
a + '>').appendTo('body'); var d = b.css('display'); b.remove(); if (d === 'none' || d === '')d = 'block'; ea[a] = d;
    } return ea[a];
  } function fa (a) { return c.isWindow(a) ? a : a.nodeType === 9 ? a.defaultView || a.parentWindow : false; } var t = E.document; var c = (function () {
    function a () { if (!b.isReady) { try { t.documentElement.doScroll('left'); } catch (j) { setTimeout(a, 1); return; }b.ready(); } } var b = function (j, s) { return new b.fn.init(j, s); }; var d = E.jQuery; var e = E.$; var f; var h = /^(?:[^<]*(<[\w\W]+>)[^>]*$|#([\w\-]+)$)/; var l = /\S/; var k = /^\s+/; var o = /\s+$/; var x = /\W/; var r = /\d/; var A = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
    var C = /^[\],:{}\s]*$/; var J = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g; var w = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g; var I = /(?:^|:|,)(?:\s*\[)+/g; var L = /(webkit)[ \/]([\w.]+)/; var g = /(opera)(?:.*version)?[ \/]([\w.]+)/; var i = /(msie) ([\w.]+)/; var n = /(mozilla)(?:.*? rv:([\w.]+))?/; var m = navigator.userAgent; var p = false; var q = []; var u; var y = Object.prototype.toString; var F = Object.prototype.hasOwnProperty; var M = Array.prototype.push; var N = Array.prototype.slice; var O = String.prototype.trim; var D = Array.prototype.indexOf; var R = {}; b.fn = b.prototype = {
      init: function (j,
        s) {
...
-1 ? this.slice(j) : this.slice(j, +j + 1);
      ...
      var j; var s; var v; var z; var H; var G = arguments[0] || {}; var K = 1; var Q = arguments.length; var ga = false;
      ...
      ready: function (j) {
        j === true && b.readyWait--;
        if (!b.readyWait || j !== true && !b.isReady) { if (!t.body) return setTimeout(b.ready, 1); b.isReady = true; if (!(j !== true && --b.readyWait > 0)) if (q) { var s = 0; var v = q; for (q = null; j = v[s++];)j.call(t, b); b.fn.trigger && b(t).trigger('ready').unbind('ready'); } }
      },
      bindReady: function () {
        if (!p) {
...
!F.call(j, 'constructor') && !F.call(j.constructor.prototype, 'isPrototypeOf')) return false; for (var s in j);return s === B || F.call(j, s);
      ...
      globalEval: function (j) {
        if (j &&
l.test(j)) { var s = t.getElementsByTagName('head')[0] || t.documentElement; var v = t.createElement('script'); v.type = 'text/javascript'; if (b.support.scriptEval)v.appendChild(t.createTextNode(j)); else v.text = j; s.insertBefore(v, s.firstChild); s.removeChild(v); }
      },
      nodeName: function (j, s) { return j.nodeName && j.nodeName.toUpperCase() === s.toUpperCase(); },
      each: function (j, s, v) {
        var z; var H = 0; var G = j.length; var K = G === B || b.isFunction(j); if (v) if (K) for (z in j) { if (s.apply(j[z], v) === false) break; } else for (;H < G;) { if (s.apply(j[H++], v) === false) break; } else if (K) {
          for (z in j) {
            if (s.call(j[z],
              z, j[z]) === false) break;
          }
      ...
      merge: function (j,
        s) { var v = j.length; var z = 0; if (typeof s.length === 'number') for (var H = s.length; z < H; z++)j[v++] = s[z]; else for (;s[z] !== B;)j[v++] = s[z++]; j.length = v; return j; },
      grep: function (j, s, v) { var z = []; var H; v = !!v; for (var G = 0, K = j.length; G < K; G++) { H = !!s(j[G], G); v !== H && z.push(j[G]); } return z; },
...
[]; return { browser: j[1] || '', version: j[2] || '0' };
    ...
    c.support = {}; var a = t.documentElement; var b = t.createElement('script'); var d = t.createElement('div'); var e = 'script' + c.now(); d.style.display = 'none'; d.innerHTML = "   <link/><table></table><a href='/a' style='color:red;float:left;opacity:.55;'>a</a><input type='checkbox'/>"; var f = d.getElementsByTagName('*'); var h = d.getElementsByTagName('a')[0]; var l = t.createElement('select');
    var k = l.appendChild(t.createElement('option')); if (!(!f || !f.length || !h)) {
      c.support = {
...
'none';
    ...
    data: function (a, b, d) {
      if (c.acceptData(a)) {
        a = a == E ? ra : a; var e = a.nodeType; var f = e ? a[c.expando] : null; var h =
c.cache; if (!(e && !f && typeof b === 'string' && d === B)) { if (e)f || (a[c.expando] = f = ++c.uuid); else h = a; if (typeof b === 'object') if (e)h[f] = c.extend(h[f], b); else c.extend(h, b); else if (e && !h[f])h[f] = {}; a = e ? h[f] : h; if (d !== B)a[b] = d; return typeof b === 'string' ? a[b] : a; }
    ...
    removeData: function (a, b) {
      if (c.acceptData(a)) {
        a = a == E ? ra : a; var d = a.nodeType; var e = d ? a[c.expando] : a; var f = c.cache; var h = d ? f[e] : e; if (b) { if (h) { delete h[b]; d && c.isEmptyObject(h) && c.removeData(a); } } else if (d && c.support.deleteExpando) delete a[c.expando]; else if (a.removeAttribute)a.removeAttribute(c.expando);
    ...
    data: function (a, b) {
      var d = null; if (typeof a === 'undefined') { if (this.length) { var e = this[0].attributes; var f; d = c.data(this[0]); for (var h = 0, l = e.length; h < l; h++) { f = e[h].name; if (f.indexOf('data-') === 0) { f = f.substr(5); ka(this[0], f, d[f]); } } } return d; } else if (typeof a === 'object') {
        return this.each(function () {
          c.data(this,
            a);
        });
      } var k = a.split('.'); k[1] = k[1] ? '.' + k[1] : ''; if (b === B) { d = this.triggerHandler('getData' + k[1] + '!', [k[0]]); if (d === B && this.length) { d = c.data(this[0], a); d = ka(this[0], a, d); } return d === B && k[1] ? this.data(k[0]) : d; } else return this.each(function () { var o = c(this); var x = [k[0], b]; o.triggerHandler('setData' + k[1] + '!', x); c.data(this, a, b); o.triggerHandler('changeData' + k[1] + '!', x); });
    },
...
c.data(a, b); if (!d) return e || []; if (!e || c.isArray(d))e = c.data(a, b, c.makeArray(d)); else e.push(d); return e;
    ...
    dequeue: function (a, b) { b = b || 'fx'; var d = c.queue(a, b); var e = d.shift(); if (e === 'inprogress')e = d.shift(); if (e) { b === 'fx' && d.unshift('inprogress'); e.call(a, function () { c.dequeue(a, b); }); } }
  }); c.fn.extend({
    queue: function (a, b) { if (typeof a !== 'string') { b = a; a = 'fx'; } if (b === B) return c.queue(this[0], a); return this.each(function () { var d = c.queue(this, a, b); a === 'fx' && d[0] !== 'inprogress' && c.dequeue(this, a); }); },
    dequeue: function (a) {
      return this.each(function () {
        c.dequeue(this,
          a);
  ...
  }); var sa = /[\n\t]/g; var ha = /\s+/; var Sa = /\r/g; var Ta = /^(?:href|src|style)$/; var Ua = /^(?:button|input)$/i; var Va = /^(?:button|input|object|select|textarea)$/i; var Wa = /^a(?:rea)?$/i; var ta = /^(?:radio|checkbox)$/i; c.props = {
    for: 'htmlFor',
    class: 'className',
    readonly: 'readOnly',
    maxlength: 'maxLength',
...
1) if (f.className) { for (var h = ' ' + f.className + ' ', l = f.className, k = 0, o = b.length; k < o; k++) if (h.indexOf(' ' + b[k] + ' ') < 0)l += ' ' + b[k]; f.className = c.trim(l); } else f.className = a;
    ...
    toggleClass: function (a, b) {
      var d = typeof a; var e = typeof b === 'boolean'; if (c.isFunction(a)) return this.each(function (f) { var h = c(this); h.toggleClass(a.call(this, f, h.attr('class'), b), b); }); return this.each(function () {
    ...
    val: function (a) {
      if (!arguments.length) {
        ...
        var x = c(this); var r = a; if (this.nodeType === 1) {
          if (k) {
            r =
a.call(this, o, x.val());
...
b.specified ? b.value : Va.test(a.nodeName) || Wa.test(a.nodeName) && a.href ? 0 : B;
  ...
  }); var X = /\.(.*)$/; var ia = /^(?:textarea|input|select)$/i; var La = /\./g; var Ma = / /g; var Xa = /[^\w\s.|`]/g; var Ya = function (a) { return a.replace(Xa, '\\$&'); }; var ua = { focusin: 0, focusout: 0 };
  c.event = {
    add: function (a, b, d, e) {
      if (!(a.nodeType === 3 || a.nodeType === 8)) {
        if (c.isWindow(a) && a !== E && !a.frameElement)a = E; if (d === false)d = U; else if (!d) return; var f, h; if (d.handler) { f = d; d = f.handler; } if (!d.guid)d.guid = c.guid++; if (h = c.data(a)) {
          var l = a.nodeType ? 'events' : '__events__'; var k = h[l]; var o = h.handle; if (typeof k === 'function') { o = k.handle; k = k.events; } else if (!k) { a.nodeType || (h[l] = h = function () {}); h.events = k = {}; } if (!o) {
            h.handle = o = function () {
              return typeof c !== 'undefined' && !c.event.triggered ? c.event.handle.apply(o.elem,
                arguments) : B;
            };
          }o.elem = a; b = b.split(' '); for (var x = 0, r; l = b[x++];) {
            h = f ? c.extend({}, f) : { handler: d, data: e }; if (l.indexOf('.') > -1) { r = l.split('.'); l = r.shift(); h.namespace = r.slice(0).sort().join('.'); } else { r = []; h.namespace = ''; }h.type = l; if (!h.guid)h.guid = d.guid; var A = k[l]; var C = c.event.special[l] || {}; if (!A) { A = k[l] = []; if (!C.setup || C.setup.call(a, e, r, o) === false) if (a.addEventListener)a.addEventListener(l, o, false); else a.attachEvent && a.attachEvent('on' + l, o); } if (C.add) {
...
d.guid;
    ...
    remove: function (a, b, d, e) {
      if (!(a.nodeType === 3 || a.nodeType === 8)) {
        if (d === false)d = U; var f; var h; var l = 0; var k; var o; var x; var r; var A; var C; var J = a.nodeType ? 'events' : '__events__'; var w = c.data(a); var I = w && w[J]; if (w && I) {
...
8) return B; a.result = B; a.target = d; b = c.makeArray(b); b.unshift(a);
        ...
        var l; e = a.target; var k = f.replace(X, ''); var o = c.nodeName(e, 'a') && k ===
'click'; var x = c.event.special[k] || {}; if ((!x._default || x._default.call(d, a) === false) && !o && !(e && e.nodeName && c.noData[e.nodeName.toLowerCase()])) { try { if (e[k]) { if (l = e['on' + k])e['on' + k] = null; c.event.triggered = true; e[k](); } } catch (r) {} if (l)e['on' + k] = l; c.event.triggered = false; }
      }
    },
    handle: function (a) {
...
c.now(); this[c.expando] = true;
  ...
  var va = function (a) { var b = a.relatedTarget; try { for (;b && b !== this;)b = b.parentNode; if (b !== this) { a.type = a.data; c.event.handle.apply(this, arguments); } } catch (d) {} }; var wa = function (a) { a.type = a.data; c.event.handle.apply(this, arguments); }; c.each({ mouseenter: 'mouseover', mouseleave: 'mouseout' }, function (a, b) { c.event.special[a] = { setup: function (d) { c.event.add(this, b, d && d.selector ? wa : va, a); }, teardown: function (d) { c.event.remove(this, b, d && d.selector ? wa : va); } }; }); if (!c.support.submitBubbles) {
    c.event.special.submit = {
      setup: function () {
        if (this.nodeName.toLowerCase() !==
'form') { c.event.add(this, 'click.specialSubmit', function (a) { var b = a.target; var d = b.type; if ((d === 'submit' || d === 'image') && c(b).closest('form').length) { a.liveFired = B; return la('submit', this, arguments); } }); c.event.add(this, 'keypress.specialSubmit', function (a) { var b = a.target; var d = b.type; if ((d === 'text' || d === 'password') && c(b).closest('form').length && a.keyCode === 13) { a.liveFired = B; return la('submit', this, arguments); } }); } else return false;
      },
      teardown: function () { c.event.remove(this, '.specialSubmit'); }
    };
  } if (!c.support.changeBubbles) {
    var V;
    var xa = function (a) { var b = a.type; var d = a.value; if (b === 'radio' || b === 'checkbox')d = a.checked; else if (b === 'select-multiple')d = a.selectedIndex > -1 ? c.map(a.options, function (e) { return e.selected; }).join('-') : ''; else if (a.nodeName.toLowerCase() === 'select')d = a.selectedIndex; return d; }; var Z = function (a, b) {
      var d = a.target; var e; var f; if (!(!ia.test(d.nodeName) || d.readOnly)) {
...
1; d < b.length;)c.proxy(a, b[d++]); return this.click(c.proxy(a, function (e) { var f = (c.data(this, 'lastToggle' + a.guid) || 0) % d; c.data(this, 'lastToggle' + a.guid, f + 1); e.preventDefault(); return b[f].apply(this, arguments) || false; }));
    ...
    c.fn[b] = function (d, e, f, h) {
      var l; var k = 0; var o; var x; var r = h || this.selector; h = h ? this : c(this.context); if (typeof d ===
'object' && !d.preventDefault) { for (l in d)h[b](l, e, d[l], r); return this; } if (c.isFunction(e)) { f = e; e = B; } for (d = (d || '').split(' '); (l = d[k++]) != null;) { o = X.exec(l); x = ''; if (o) { x = o[0]; l = l.replace(X, ''); } if (l === 'hover')d.push('mouseenter' + x, 'mouseleave' + x); else { o = l; if (l === 'focus' || l === 'blur') { d.push(ya[l] + x); l += x; } else l = (ya[l] || l) + x; if (b === 'live') { x = 0; for (var A = h.length; x < A; x++)c.event.add(h[x], 'live.' + Y(l, r), { data: e, selector: r, handler: f, origType: l, origHandler: f, preType: o }); } else h.unbind('live.' + Y(l, r), f); } } return this;
  ...
  (function () {
    ...
    } var d = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g; var e = 0; var f = Object.prototype.toString; var h = false; var l = true; [0, 0].sort(function () { l = false; return 0; }); var k = function (g, i, n, m) {
      n = n || []; var p = i = i || t; if (i.nodeType !== 1 && i.nodeType !== 9) return []; if (!g || typeof g !== 'string') return n; var q; var u; var y; var F; var M; var N = true; var O = k.isXML(i); var D = []; var R = g; do {
...
l; g.sort(w); if (h) for (var i = 1; i < g.length; i++)g[i] === g[i - 1] && g.splice(i--, 1);
      ...
      var m; if (!g) return []; for (var p = 0, q = o.order.length; p < q; p++) { var u; var y = o.order[p]; if (u = o.leftMatch[y].exec(g)) { var F = u[1]; u.splice(1, 1); if (F.substr(F.length - 1) !== '\\') { u[1] = (u[1] || '').replace(/\\/g, ''); m = o.find[y](u, i, n); if (m != null) { g = g.replace(o.match[y], ''); break; } } } }m || (m = i.getElementsByTagName('*'));
      return { set: m, expr: g };
    }; k.filter = function (g, i, n, m) {
      for (var p, q, u = g, y = [], F = i, M = i && i[0] && k.isXML(i[0]); g && i.length;) {
        for (var N in o.filter) {
          if ((p = o.leftMatch[N].exec(g)) != null && p[2]) {
            var O; var D; var R = o.filter[N]; D = p[1]; q = false; p.splice(1, 1); if (D.substr(D.length - 1) !== '\\') {
...
B) { n || (F = y); g = g.replace(o.match[N], ''); if (!q) return []; break; }
      ...
      relative: {
        '+': function (g, i) {
          var n = typeof i === 'string'; var m = n && !/\W/.test(i); n = n && !m; if (m)i = i.toLowerCase(); m = 0; for (var p = g.length, q; m < p; m++) {
            if (q = g[m]) {
...
i ? q || false : q === i;
        ...
        '>': function (g, i) { var n; var m = typeof i === 'string'; var p = 0; var q = g.length; if (m && !/\W/.test(i)) for (i = i.toLowerCase(); p < q; p++) { if (n = g[p]) { n = n.parentNode; g[p] = n.nodeName.toLowerCase() === i ? n : false; } } else { for (;p < q; p++) if (n = g[p])g[p] = m ? n.parentNode : n.parentNode === i; m && k.filter(i, g, true); } },
        '': function (g, i, n) { var m; var p = e++; var q = b; if (typeof i === 'string' && !/\W/.test(i)) { m = i = i.toLowerCase(); q = a; }q('parentNode', i, p, g, m, n); },
        '~': function (g, i, n) {
          var m; var p = e++; var q = b; if (typeof i === 'string' && !/\W/.test(i)) {
            m =
i = i.toLowerCase(); q = a;
...
0 === i;
      ...
      filter: {
        PSEUDO: function (g, i, n, m) { var p = i[1]; var q = o.filters[p]; if (q) return q(g, n, i, m); else if (p === 'contains') return (g.textContent || g.innerText || k.getText([g]) || '').indexOf(i[3]) >= 0; else if (p === 'not') { i = i[3]; n = 0; for (m = i.length; n < m; n++) if (i[n] === g) return false; return true; } else k.error('Syntax error, unrecognized expression: ' + p); },
        CHILD: function (g, i) {
          var n = i[1]; var m = g; switch (n) {
...
i;
        ...
        ATTR: function (g, i) { var n = i[1]; n = o.attrHandle[n] ? o.attrHandle[n](g) : g[n] != null ? g[n] : g.getAttribute(n); var m = n + ''; var p = i[2]; var q = i[4]; return n == null ? p === '!=' : p === '=' ? m === q : p === '*=' ? m.indexOf(q) >= 0 : p === '~=' ? (' ' + m + ' ').indexOf(q) >= 0 : !q ? m && n !== false : p === '!=' ? m !== q : p === '^=' ? m.indexOf(q) === 0 : p === '$=' ? m.substr(m.length - q.length) === q : p === '|=' ? m === q || m.substr(0, q.length + 1) === q + '-' : false; },
        POS: function (g, i, n, m) {
          var p = o.setFilters[i[2]];
          if (p) return p(g, n, i, m);
        }
      }
    }; var x = o.match.POS; var r = function (g, i) { return '\\' + (i - 0 + 1); }; var A; for (A in o.match) { o.match[A] = RegExp(o.match[A].source + /(?![^\[]*\])(?![^\(]*\))/.source); o.leftMatch[A] = RegExp(/(^(?:.|\r|\n)*?)/.source + o.match[A].source.replace(/\\(\d+)/g, r)); } var C = function (g, i) { g = Array.prototype.slice.call(g, 0); if (i) { i.push.apply(i, g); return i; } return g; }; try { Array.prototype.slice.call(t.documentElement.childNodes, 0); } catch (J) {
      C = function (g, i) {
        var n = 0; var m = i || []; if (f.call(g) === '[object Array]') {
      ...
      w = function (g, i) {
        var n; var m; var p = []; var q = []; n = g.parentNode; m = i.parentNode; var u = n; if (g === i) { h = true; return 0; } else if (n === m) return I(g, i); else if (n) { if (!m) return 1; } else return -1;
...
(function () {
  var g = k; var i = t.createElement('div'); i.innerHTML = "<p class='TEST'></p>"; if (!(i.querySelectorAll && i.querySelectorAll('.TEST').length === 0)) {
    k = function (m, p, q, u) {
      p = p || t; m = m.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']"); if (!u && !k.isXML(p)) {
        if (p.nodeType === 9) try { return C(p.querySelectorAll(m), q); } catch (y) {} else if (p.nodeType === 1 && p.nodeName.toLowerCase() !== 'object') {
          var F = p.getAttribute('id'); var M = F || '__sizzle__'; F || p.setAttribute('id', M); try { return C(p.querySelectorAll('#' + M + ' ' + m), q); } catch (N) {} finally {
            F ||
...
}()); (function () { var g = t.documentElement; var i = g.matchesSelector || g.mozMatchesSelector || g.webkitMatchesSelector || g.msMatchesSelector; var n = false; try { i.call(t.documentElement, "[test!='']:sizzle"); } catch (m) { n = true; } if (i)k.matchesSelector = function (p, q) { q = q.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']"); if (!k.isXML(p)) try { if (n || !o.match.PSEUDO.test(q) && !/!=/.test(q)) return i.call(p, q); } catch (u) {} return k(q, null, null, [p]).length > 0; }; })(); (function () {
      var g =
t.createElement('div'); g.innerHTML = "<div class='test e'></div><div class='test'></div>"; if (!(!g.getElementsByClassName || g.getElementsByClassName('e').length === 0)) { g.lastChild.className = 'e'; if (g.getElementsByClassName('e').length !== 1) { o.order.splice(1, 0, 'CLASS'); o.find.CLASS = function (i, n, m) { if (typeof n.getElementsByClassName !== 'undefined' && !m) return n.getElementsByClassName(i[1]); }; g = null; } }
  ...
  })(); var Za = /Until$/; var $a = /^(?:parents|prevUntil|prevAll)/; var ab = /,/; var Na = /^.[^:#\[\.,]*$/; var bb = Array.prototype.slice; var cb = c.expr.match.POS; c.fn.extend({
    find: function (a) { for (var b = this.pushStack('', 'find', a), d = 0, e = 0, f = this.length; e < f; e++) { d = b.length; c.find(a, this[e], b); if (e > 0) for (var h = d; h < b.length; h++) for (var l = 0; l < d; l++) if (b[l] === b[h]) { b.splice(h--, 1); break; } } return b; },
    ...
    closest: function (a, b) {
      var d = []; var e; var f; var h = this[0]; if (c.isArray(a)) {
        var l; var k = {}; var o = 1; if (h && a.length) {
...
h.parentNode; o++;
    ...
    add: function (a, b) {
      var d = typeof a === 'string' ? c(a, b || this.context)
        : c.makeArray(a); var e = c.merge(this.get(), d); return this.pushStack(!d[0] || !d[0].parentNode || d[0].parentNode.nodeType === 11 || !e[0] || !e[0].parentNode || e[0].parentNode.nodeType === 11 ? e : c.unique(e));
    },
...
e.push(a); a = a[b];
  ...
  }); var za = / jQuery\d+="(?:\d+|null)"/g; var $ = /^\s+/; var Aa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig; var Ba = /<([\w:]+)/; var db = /<tbody/i; var eb = /<|&#?\w+;/; var Ca = /<(?:script|object|embed|option|style)/i; var Da = /checked\s*(?:[^=]|=\s*.checked.)/i; var fb = /\=([^="'>\s]+\/)>/g; var P = {
    option: [1,
...
c(this); d.text(a.call(this, b, d.text()));
    ...
    wrapInner: function (a) { if (c.isFunction(a)) return this.each(function (b) { c(this).wrapInner(a.call(this, b)); }); return this.each(function () { var b = c(this); var d = b.contents(); d.length ? d.wrapAll(a) : b.append(a); }); },
    ...
    clone: function (a) { var b = this.map(function () { if (!c.support.noCloneEvent && !c.isXMLDoc(this)) { var d = this.outerHTML; var e = this.ownerDocument; if (!d) { d = e.createElement('div'); d.appendChild(this.cloneNode(true)); d = d.innerHTML; } return c.clean([d.replace(za, '').replace(fb, '="$1">').replace($, '')], e)[0]; } else return this.cloneNode(true); }); if (a === true) { na(this, b); na(this.find('*'), b.find('*')); } return b; },
    html: function (a) {
    ...
    replaceWith: function (a) {
      if (this[0] && this[0].parentNode) {
        if (c.isFunction(a)) {
          return this.each(function (b) {
            var d =
c(this); var e = d.html(); d.replaceWith(a.call(this, b, e));
          });
        } if (typeof a !== 'string')a = c(a).detach(); return this.each(function () { var b = this.nextSibling; var d = this.parentNode; c(this).remove(); b ? c(b).before(a) : c(d).append(a); });
      } else return this.pushStack(c(c.isFunction(a) ? a() : a), 'replaceWith', a);
    },
    detach: function (a) { return this.remove(a, true); },
    domManip: function (a, b, d) {
      var e; var f; var h; var l = a[0]; var k = []; if (!c.support.checkClone && arguments.length === 3 && typeof l === 'string' && Da.test(l)) {
        return this.each(function () {
          c(this).domManip(a,
            b, d, true);
        });
...
b[0] && b[0].ownerDocument || t;
        ...
        if (typeof l === 'number')l += ''; if (l) {
          if (typeof l === 'string' && !eb.test(l))l = b.createTextNode(l); else if (typeof l === 'string') {
            l = l.replace(Aa, '<$1></$2>'); var k = (Ba.exec(l) || ['', ''])[1].toLowerCase(); var o = P[k] || P._default; var x = o[0]; var r = b.createElement('div'); for (r.innerHTML = o[1] + l + o[2]; x--;)r = r.lastChild; if (!c.support.tbody) {
...
1; o >= 0; --o)c.nodeName(k[o], 'tbody') && !k[o].childNodes.length && k[o].parentNode.removeChild(k[o]);
  ...
  var jb = /^-?\d/; var kb = { position: 'absolute', visibility: 'hidden', display: 'block' }; var Pa = ['Left', 'Right']; var Qa = ['Top', 'Bottom']; var W; var Ga; var aa; var lb = function (a, b) { return b.toUpperCase(); }; c.fn.css = function (a, b) { if (arguments.length === 2 && b === B) return this; return c.access(this, a, b, true, function (d, e, f) { return f !== B ? c.style(d, e, f) : c.css(d, e); }); }; c.extend({
    ...
    css: function (a, b, d) {
      var e; var f = c.camelCase(b);
      var h = c.cssHooks[f]; b = c.cssProps[f] || f; if (h && 'get' in h && (e = h.get(a, true, d)) !== B) return e; else if (W) return W(a, b, f);
    },
    swap: function (a, b, d) { var e = {}; var f; for (f in b) { e[f] = a.style[f]; a.style[f] = b[f]; }d.call(a); for (f in b)a.style[f] = e[f]; },
    ...
    c.cssHooks.opacity = {
      ...
      set: function (a, b) {
        var d = a.style; d.zoom = 1; var e = c.isNaN(b) ? '' : 'alpha(opacity=' + b * 100 + ')'; var f =
d.filter || ''; d.filter = Ea.test(f) ? f.replace(Ea, e) : d.filter + ' ' + e;
    ...
    aa = function (a, b) {
      var d; var e; var f = a.currentStyle && a.currentStyle[b]; var h = a.style; if (!Fa.test(f) && jb.test(f)) {
        d = h.left;
  ...
  }W = Ga || aa; if (c.expr && c.expr.filters) { c.expr.filters.hidden = function (a) { var b = a.offsetHeight; return a.offsetWidth === 0 && b === 0 || !c.support.reliableHiddenOffsets && (a.style.display || c.css(a, 'display')) === 'none'; }; c.expr.filters.visible = function (a) { return !c.expr.filters.hidden(a); }; } var mb = c.now(); var nb = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi;
  var ob = /^(?:select|textarea)/i; var pb = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i; var qb = /^(?:GET|HEAD)$/; var Ra = /\[\]$/; var T = /\=\?(&|$)/; var ja = /\?/; var rb = /([?&])_=[^&]*/; var sb = /^(\w+:)?\/\/([^\/?#]+)/; var tb = /%20/g; var ub = /#.*$/; var Ha = c.fn.load; c.fn.extend({
    load: function (a, b, d) {
...
!this.disabled && (this.checked || ob.test(this.nodeName) || pb.test(this.type));
    ...
    ajax: function (a) {
      var b = c.extend(true, {}, c.ajaxSettings, a); var d; var e; var f; var h = b.type.toUpperCase(); var l = qb.test(h); b.url = b.url.replace(ub, ''); b.context = a && a.context != null ? a.context : b; if (b.data && b.processData && typeof b.data !== 'string')b.data = c.param(b.data, b.traditional); if (b.dataType === 'jsonp') {
...
!T.test(b.data))b.data = (b.data ? b.data + '&' : '') + (b.jsonp || 'callback') + '=?'; b.dataType = 'json';
        ...
        b.cache =
false;
      } if (b.cache === false && l) { var o = c.now(); var x = b.url.replace(rb, '$1_=' + o); b.url = x + (x === b.url ? (ja.test(b.url) ? '&' : '?') + '_=' + o : ''); } if (b.data && l)b.url += (ja.test(b.url) ? '&' : '?') + b.data; b.global && c.active++ === 0 && c.event.trigger('ajaxStart'); o = (o = sb.exec(b.url)) && (o[1] && o[1].toLowerCase() !== location.protocol || o[2].toLowerCase() !== location.host); if (b.dataType === 'script' && h === 'GET' && o) {
...
encodeURIComponent(h) + '=' + encodeURIComponent(l);
    ...
    httpNotModified: function (a, b) {
      ...
      var e = a.getResponseHeader('Etag'); if (d)c.lastModified[b] = d; if (e)c.etag[b] = e; return a.status === 304;
    },
    httpData: function (a, b, d) { var e = a.getResponseHeader('content-type') || ''; var f = b === 'xml' || !b && e.indexOf('xml') >= 0; a = f ? a.responseXML : a.responseText; f && a.documentElement.nodeName === 'parsererror' && c.error('parsererror'); if (d && d.dataFilter)a = d.dataFilter(a, b); if (typeof a === 'string') if (b === 'json' || !b && e.indexOf('json') >= 0)a = c.parseJSON(a); else if (b === 'script' || !b && e.indexOf('javascript') >= 0)c.globalEval(a); return a; }
  });
  if (E.ActiveXObject)c.ajaxSettings.xhr = function () { if (E.location.protocol !== 'file:') try { return new E.XMLHttpRequest(); } catch (a) {} try { return new E.ActiveXObject('Microsoft.XMLHTTP'); } catch (b) {} }; c.support.ajax = !!c.ajaxSettings.xhr(); var ea = {}; var vb = /^(?:toggle|show|hide)$/; var wb = /^([+\-]=)?([\d+.\-]+)(.*)$/; var ba; var pa = [['height', 'marginTop', 'marginBottom', 'paddingTop', 'paddingBottom'], ['width', 'marginLeft', 'marginRight', 'paddingLeft', 'paddingRight'], ['opacity']]; c.fn.extend({
    show: function (a, b, d) {
      if (a || a === 0) {
    ...
    animate: function (a, b, d, e) {
      var f = c.speed(b,
        ...
        var h = c.extend({}, f); var l; var k = this.nodeType === 1; var o = k && c(this).is(':hidden'); var x = this; for (l in a) {
...
'inline') this.style.display = 'inline-block'; else { this.style.display = 'inline'; this.style.zoom = 1; }
          ...
          var J = new c.fx(x, h, A); if (vb.test(C))J[C === 'toggle' ? o ? 'show' : 'hide' : C](a); else {
            var w = wb.exec(C); var I = J.cur() || 0; if (w) {
              var L = parseFloat(w[2]); var g = w[3] || 'px'; if (g !== 'px') {
...
Math.PI) / 2 + 0.5) * e + d;
    ...
    timers: [],
    fx: function (a, b, d) { this.options = b; this.elem = a; this.prop = d; if (!b.orig)b.orig = {}; }
  }); c.fx.prototype = {
    update: function () { this.options.step && this.options.step.call(this.elem, this.now, this); (c.fx.step[this.prop] || c.fx.step._default)(this); },
    ...
    custom: function (a, b, d) {
      ...
      var f = this; var h = c.fx; this.startTime = c.now(); this.start = a; this.end = b; this.unit = d || this.unit || 'px'; this.now = this.start; this.pos = this.state = 0; e.elem = this.elem; if (e() && c.timers.push(e) && !ba)ba = setInterval(h.tick, h.interval);
    },
    ...
    step: function (a) {
      var b = c.now(); var d = true; if (a || b >= this.options.duration + this.startTime) {
        this.now = this.end; this.pos = this.state = 1; this.update(); this.options.curAnim[this.prop] = true; for (var e in this.options.curAnim) if (this.options.curAnim[e] !== true)d = false; if (d) {
          if (this.options.overflow != null && !c.support.shrinkWrapBlocks) { var f = this.elem; var h = this.options; c.each(['', 'X', 'Y'], function (k, o) { f.style['overflow' + o] = h.overflow[k]; }); } this.options.hide && c(this.elem).hide(); if (this.options.hide ||
...
b.elem;
  ...
  } var xb = /^t(?:able|d|h)$/i; var Ia = /^(?:body|html)$/i; c.fn.offset = 'getBoundingClientRect' in t.documentElement ? function (a) {
...
h.scrollTop || b.scrollTop) - (h.clientTop || b.clientTop || 0),
    ...
    var b = this[0]; if (a) return this.each(function (x) { c.offset.setOffset(this, a, x); }); if (!b || !b.ownerDocument) return null; if (b === b.ownerDocument.body) return c.offset.bodyOffset(b); c.offset.initialize(); var d; var e = b.offsetParent; var f = b.ownerDocument; var h = f.documentElement; var l = f.body; d = (f = f.defaultView) ? f.getComputedStyle(b, null) : b.currentStyle;
...
parseFloat(d.borderTopWidth) || 0; o += parseFloat(d.borderLeftWidth) || 0;
    ...
    initialize: function () {
      var a = t.body; var b = t.createElement('div'); var d; var e; var f; var h = parseFloat(c.css(a, 'marginTop')) || 0; c.extend(b.style, {
        position: 'absolute',
        top: 0,
        left: 0,
        margin: 0,
...
f.offsetTop === 5; e.style.position = 'fixed'; e.style.top = '20px'; this.supportsFixedPosition = e.offsetTop === 20 || e.offsetTop === 15; e.style.position = e.style.top = ''; d.style.overflow = 'hidden'; d.style.position = 'relative'; this.subtractsBorderForOverflowNotVisible = e.offsetTop === -5; this.doesNotIncludeMarginInBodyOffset = a.offsetTop !== h; a.removeChild(b); c.offset.initialize = c.noop;
    ...
    bodyOffset: function (a) {
      var b = a.offsetTop; var d = a.offsetLeft; c.offset.initialize(); if (c.offset.doesNotIncludeMarginInBodyOffset) {
        b += parseFloat(c.css(a,
          'marginTop')) || 0; d += parseFloat(c.css(a, 'marginLeft')) || 0;
      } return { top: b, left: d };
    },
    setOffset: function (a, b, d) {
      var e = c.css(a, 'position'); if (e === 'static')a.style.position = 'relative'; var f = c(a); var h = f.offset(); var l = c.css(a, 'top'); var k = c.css(a, 'left'); var o = e === 'absolute' && c.inArray('auto', [l, k]) > -1; e = {}; var x = {}; if (o)x = f.position(); l = o ? x.top : parseInt(l, 10) || 0; k = o ? x.left : parseInt(k, 10) || 0; if (c.isFunction(b))b = b.call(a, d, h); if (b.top != null)e.top = b.top - h.top + l; if (b.left != null)e.left = b.left - h.left + k; 'using' in b ? b.using.call(a,
        e) : f.css(e);
    }
  }; c.fn.extend({
    position: function () { if (!this[0]) return null; var a = this[0]; var b = this.offsetParent(); var d = this.offset(); var e = Ia.test(b[0].nodeName) ? { top: 0, left: 0 } : b.offset(); d.top -= parseFloat(c.css(a, 'marginTop')) || 0; d.left -= parseFloat(c.css(a, 'marginLeft')) || 0; e.top += parseFloat(c.css(b[0], 'borderTopWidth')) || 0; e.left += parseFloat(c.css(b[0], 'borderLeftWidth')) || 0; return { top: d.top - e.top, left: d.left - e.left }; },
...
c.css(a, 'position') === 'static';)a = a.offsetParent; return a;
  ...
  }); c.each(['Left', 'Top'], function (a, b) { var d = 'scroll' + b; c.fn[d] = function (e) { var f = this[0]; var h; if (!f) return null; if (e !== B) return this.each(function () { if (h = fa(this))h.scrollTo(!a ? e : c(h).scrollLeft(), a ? e : c(h).scrollTop()); else this[d] = e; }); else return (h = fa(f)) ? 'pageXOffset' in h ? h[a ? 'pageYOffset' : 'pageXOffset'] : c.support.boxModel && h.document.documentElement[d] || h.document.body[d] : f[d]; }; }); c.each(['Height', 'Width'], function (a, b) {
    var d = b.toLowerCase();
